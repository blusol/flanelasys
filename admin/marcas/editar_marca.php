<?php
	...
	if ($_POST) {
		...
		$objMarcas->editaMarcas($objMarcas);
...
?>
			<div class="data">
				...
				<form method="POST" action="">
					<table>
						<tr>
							<td> Descrição: <input type="text" name="des_marca" value="<?php echo $arrMarcas[0]['des_marca']; ?>"></td>
						</tr>
						<tr>						
<?php
...
?>						
						...
						<tr>
							<td>
							    <input type="hidden" name="cod_marca" value="<?php echo $arrMarcas[0]['cod_marca']; ?>">
